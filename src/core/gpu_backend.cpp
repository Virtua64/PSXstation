                                                   ...
                                                   const GSVector4i draw_rect, bool postfx)
{
  ...
  if (display_texture)
  {
    ...
    g_gpu_device->SetViewport(0, 0, target_width, target_height);
    g_gpu_device->SetScissor(real_draw_rect);
    ...
    const GSVector4 xy = GetScreenQuadClipSpaceCoordinates(real_draw_rect, GSVector2i(target_width, target_height));
    switch (uv_rotation)
    {
