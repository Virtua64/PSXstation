...
static void FetchHashLibraryCallback(int result, const char* error_message, rc_client_hash_library_t* list,
                                     rc_client_t* client, void* callback_userdata);
static void FetchAllProgressCallback(int result, const char* error_message, rc_client_all_progress_t* list,
                                     rc_client_t* client, void* callback_userdata);

static void BuildHashDatabase(const rc_client_hash_library_t* hashlib, const rc_client_all_progress_t* allprog);
...
static void BuildProgressDatabase(const rc_client_all_progress_t* allprog);
...
struct State
{
  ...
  rc_client_all_progress_t* fetch_all_progress_result = nullptr;
};
...
void Achievements::BeginRefreshHashDatabase()
{
  ...
  s_state.fetch_all_progress_request =
    rc_client_begin_fetch_all_progress(s_state.client, RC_CONSOLE_PLAYSTATION, FetchAllProgressCallback, nullptr);
...
void Achievements::FetchAllProgressCallback(int result, const char* error_message, rc_client_all_progress_t* list,
                                            rc_client_t* client, void* callback_userdata)
{
...
void Achievements::CancelHashDatabaseRequests()
{
  ...
  {
    rc_client_destroy_all_progress(s_state.fetch_all_progress_result);
...
void Achievements::BuildHashDatabase(const rc_client_hash_library_t* hashlib, const rc_client_all_progress_t* allprog)
{
  ...
  for (const rc_client_all_progress_entry_t& entry :
       std::span<const rc_client_all_progress_entry_t>(allprog->entries, allprog->num_entries))
  {
...
void Achievements::BuildProgressDatabase(const rc_client_all_progress_t* allprog)
{
